document.addEventListener('DOMContentLoaded', function() {
    ...
    // Manejar clic en elementos del menú (excepto el menú principal)
    const navItems = document.querySelectorAll('.nav-item');
    navItems.forEach(item => {
        item.addEventListener('click', function(e) {
            // Si no es el menú principal, prevenir acción por ahora
            if (!this.getAttribute('href').includes('menu-principal')) {
                e.preventDefault();
